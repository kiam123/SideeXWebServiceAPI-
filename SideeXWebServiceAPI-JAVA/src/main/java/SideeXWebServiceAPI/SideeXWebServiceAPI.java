...
//	public String runTestSuite(String serverURL, File file, MailMessage mail) throws Exception {
//		JSONObject jsonObject = new JSONObject(mail);
//		RequestBody requestBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
//				.addFormDataPart("file", file.getName(), RequestBody.create(file, MediaType.parse("application/zip")))
//				.addFormDataPart("mail", jsonObject.toString()).build();
//
//		Request request = new Request.Builder().url(serverURL).post(requestBody).build();
//
//		try (Response response = httpClient.newCall(request).execute()) {
...
//	}
//
//	public String runTestSuite(String serverURL, File file, SlackMessage message) throws Exception {
//		JSONObject jsonObject = new JSONObject(message);
//		RequestBody requestBody = new MultipartBody.Builder().setType(MultipartBody.FORM)
//				.addFormDataPart("file", file.getName(), RequestBody.create(file, MediaType.parse("application/zip")))
//				.addFormDataPart("slack", jsonObject.toString()).build();
//
//		Request request = new Request.Builder().url(serverURL).post(requestBody).build(); 
//
//		try (Response response = httpClient.newCall(request).execute()) {
